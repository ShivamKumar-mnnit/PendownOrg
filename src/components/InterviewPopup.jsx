      ...
      {visible && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-md rounded-2xl border border-(--color-border) bg-(--color-card) p-6 sm:p-7 shadow-2xl"
          ...
          >
            <button
              ...
              onClick={dismiss}
              aria-label="Close"
              className="absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-full border border-(--color-border) text-(--color-fg-muted) hover:text-(--color-fg) transition-colors"
            >
              <X className="h-4 w-4" />
            </button>
            ...
            {sent ? (
              ...
              <>
                ...
                <form onSubmit={handleSubmit} noValidate className="mt-5 space-y-3.5">
                  ...
                  <button
                    type="submit"
                    className="w-full rounded-full bg-(--color-accent-solid) px-6 py-3 text-sm font-semibold text-white hover:bg-(--color-accent-solid-hover) transition-colors"
                  >
                    Confirm on WhatsApp
                  </button>
