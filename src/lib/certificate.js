...
// this is InoByt's own completion certificate (like a participation
...
export function generateCertificate({ name, domain, mentor, dateLabel }) {
  ...
  wrapCenteredText(ctx, "InoByt", canvas.width / 2, 165);
  ...
  ctx.fillText("InoByt Team", canvas.width - 150, footerY);
  ctx.fillStyle = "#a1a1aa";
  ctx.font = "16px Arial, sans-serif";
